<?php
	if(!empty($_POST)){
		...
		$query = "INSERT INTO users(username, email, wachtwoord) VALUES ('$username','$email','$password');";

		$controle = "SELECT * FROM users WHERE username='$username'";
		$qry = $conn->query($controle);
	...
	<div class="content container">
		<div class="login">
			...
			<form action="" method="post">
				...
				<button type="submit" class="btn btn-diw-blue">Registreren</button><br>
				<a href="login.php">Aanmelden met een bestaand account</a>
			</form>
		</div><!-- ./login -->
